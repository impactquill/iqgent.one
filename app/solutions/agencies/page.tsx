        ...
        <Container size="large">
          <div className="max-w-5xl mx-auto text-center py-20">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-emerald-200 bg-emerald-50 mb-8">
              <span className="text-sm text-emerald-700 font-medium">For Agencies</span>
            </div>
            ...
            <p className="text-xl text-neutral-600 mb-10 leading-relaxed max-w-3xl mx-auto">
              Agencies need to deliver results at scale. IQgent One helps you provide 
              premium research and personalization for all your clients.
            </p>
        ...
        <Container size="large">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-neutral-600 mb-10">
              Multi-client management with priority support for agencies.
            </p>
            <Button variant="primary" size="lg">
              Talk to Sales
            </Button>
